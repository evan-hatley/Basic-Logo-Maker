...
describe('Circle', () => {
    it('tests for a green circle', () => {
        ...
        expect(circle.render()).toContain(`fill="${this.shapeColor}"`);
    })
...
describe('Triangle', () => {
    it('tests for a blue triangle', () => {
        ...
        expect(triangle.render()).toContain(`fill="${this.shapeColor}"`);
    })
})
...
describe('Square', () => {
    it('tests for a black square', () => {
        ...
        expect(square.render()).toContain(`fill="${this.shapeColor}"`);
    })
})